...
@section('content')
    ...
    $h4_15 = __('tours.recomendados.amazon_title');
    $p_18 = __('tours.recomendados.amazon_desc');

    $h4_16 = __('tours.recomendados.costa_title');
    $p_19 = __('tours.recomendados.costa_desc');
        ...
        <div class="booking-form-container">
            ...
            <form class="booking-form" id="bookingForm" method="POST" action="{{ route('turismo.send') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="tourName" name="tourName" value="Sobrevuelo Choquequirao" required readonly>
                </div>
                <div class="form-group">
