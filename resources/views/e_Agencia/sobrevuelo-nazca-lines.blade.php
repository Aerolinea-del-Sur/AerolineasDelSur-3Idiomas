...
@section('content')
    ...
    $h4_14 = __('tours.recomendados.titicaca_title');
    $p_17 = __('tours.recomendados.titicaca_desc');

    $h4_15 = __('tours.recomendados.vinicunca_title');
    $p_18 = __('tours.recomendados.vinicunca_desc');

    $h4_16 = __('tours.recomendados.sacredvalley_title');
    $p_19 = __('tours.recomendados.sacredvalley_desc');
    ...
    <div class="cta-wrapper" style="text-align: center; margin-top: 40px; margin-bottom: 40px;">
        <style>
            .cta-button:hover {
        ...
        <a href="https://wa.me/51932475995?text=Hola,%20deseo%20cotizar%20el%20sobrevuelo%20a%20las%20Líneas%20de%20Nazca" target="_blank" class="cta-button" style="display: inline-flex; align-items: center; justify-content: center; background: linear-gradient(to right, #d4af37, #f3d056); color: #000; padding: 12px 28px; border-radius: 30px; font-weight: bold; font-size: 1.1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(212, 175, 55, 0.3); transition: all 0.3s ease;">
            <i class="fas fa-plane-departure" style="margin-right: 10px;"></i> Cotizar Sobrevuelo Líneas de Nazca
        </a>
    </div>
