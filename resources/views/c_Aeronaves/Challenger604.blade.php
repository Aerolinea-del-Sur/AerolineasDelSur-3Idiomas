@php
    ...
    $seo = seo()
        ->title("$aircraft_model - Jet Premium | Aerolíneas del Sur")
        ->description("El $aircraft_model es un jet ejecutivo premium para 12 pasajeros con alcance intercontinental.")
        ->keywords(['challenger 604 perú', 'bombardier 604', 'jet ejecutivo premium', 'vuelo intercontinental'])
        ->image(asset('img/aeronaves/aviones/Challenger604.webp'))
                        ...
                        <div class="new-carousel-container">
                            <div class="new-carousel-track">
                                <div class="new-carousel-slide current-slide">
                                    <img src="/img/aeronaves/aviones/Challenger604-1.webp" alt="challenger 604"
                                        class="carousel-image" sizes="(max-width: 890px) 550px, 
                                                (max-width: 310px) 310px, 
                                                400px" title="challenger 604" width="1200" height="800" loading="lazy"
                                        decoding="async"
                                    ...
                                    <scripttype="application /ld+json">
                                        ...
                                        "@type": "ImageObject",
                                        "contentUrl":
                                        "https://www.micosina.online/img/aeronaves/aviones/Challenger601-1.webp",
                                        "creator": {
                                        "@type": "Organization",
                                        },
                                ...
                                <div class="new-carousel-slide">
                                    <img src="/img/aeronaves/aviones/Challenger604-2.webp" alt="challenger 604 range"
                                        class="carousel-image" sizes="(max-width: 890px) 550px, 
                                                (max-width: 310px) 310px, 
                                                400px" title="challenger 604 range" width="1200" height="800"
                                    ...
                                    <scripttype="application /ld+json">
                                        ...
                                        "@type": "ImageObject",
                                        "contentUrl":
                                        "https://www.micosina.online/img/aeronaves/aviones/Challenger601-2.webp",
                                        "creator": {
                                        "@type": "Organization",
                                        },
                                ...
                                <div class="new-carousel-slide">
                                    <img src="/img/aeronaves/aviones/Challenger604-3.webp" alt="challenger 604 jet"
                                        class="carousel-image" sizes="(max-width: 890px) 550px, 
                                                (max-width: 310px) 310px, 
                                                400px" title="challenger 604 jet" width="1200" height="800" loading="lazy"
                                        decoding="async"
                                        style="width: 100%; height: 100%; object-fit: cover; border-radius: 15px;">
                                    <scripttype="application /ld+json">
                                        {
                                        ...
                                        "@type": "ImageObject",
                                        "contentUrl":
                                        "https://www.micosina.online/img/aeronaves/aviones/Challenger601-3.webp",
                                        "creator": {
                                        "@type": "Organization",
                                        },
                                ...
                                <div class="new-carousel-slide">
                                    <img src="/img/aeronaves/aviones/Challenger604-4.webp" alt="bombardier challenger 604"
                                        class="carousel-image" sizes="(max-width: 890px) 550px, 
                                                (max-width: 310px) 310px, 
                                                400px" title="bombardier challenger 604" width="1200" height="800"
                                        loading="lazy" decoding="async"
                                        style="width: 100%; height: 100%; object-fit: cover; border-radius: 15px;">
                                    <scripttype="application /ld+json">
                                        {
                                        ...
                                        "@type": "ImageObject",
                                        "contentUrl":
                                        "https://www.micosina.online/img/aeronaves/aviones/Challenger601-4.webp",
                                        "creator": {
                                        "@type": "Organization",
                                        },
                ...
                <section class="aircraft-capacity">
                    ...
                    <div class="capacity-layout">
                        ...
                        <div class="seating-diagram">
                            <img src="/img/aeronaves/aviones/Challenger604.webp"
                                alt="Bombardier Challenger 604 jet para vuelos charter empresariales en Perú"
