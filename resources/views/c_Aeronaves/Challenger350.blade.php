                        ...
                        <div class="new-carousel-container">
                            <div class="new-carousel-track">
                                <div class="new-carousel-slide current-slide">
                                    <img src="/img/aeronaves/aviones/Challenger350-1.webp" alt="bombardier challenger 350"
                                        class="carousel-image" sizes="(max-width: 890px) 550px, 
                                                (max-width: 310px) 310px, 
                                                400px" title="bombardier challenger 350" width="1200" height="800"
                                ...
                                <div class="new-carousel-slide">
                                    <img src="/img/aeronaves/aviones/Challenger350-2.webp" alt="challenger 350 jet"
                                        class="carousel-image" sizes="(max-width: 890px) 550px, 
                                                (max-width: 310px) 310px, 
                                                400px" title="challenger 350 jet" width="1200" height="800" loading="lazy"
                                        decoding="async"
                                        style="width: 100%; height: 100%; object-fit: cover; border-radius: 15px;">
                                    <scripttype="application /ld+json">
                                        {
                                ...
                                <div class="new-carousel-slide">
                                    <img src="/img/aeronaves/aviones/Challenger350-3.webp" alt="challenger 350"
                                        class="carousel-image" sizes="(max-width: 890px) 550px, 
                                                (max-width: 310px) 310px, 
                                                400px" title="challenger 350" width="1200" height="800" loading="lazy"
                                        decoding="async"
                                        style="width: 100%; height: 100%; object-fit: cover; border-radius: 15px;">
                                    <scripttype="application /ld+json">
                                        {
                                ...
                                <div class="new-carousel-slide">
                                    <img src="/img/aeronaves/aviones/Challenger350-4.webp" alt="bombardier Challenger 350"
                                        class="carousel-image" sizes="(max-width: 890px) 550px, 
                                                (max-width: 310px) 310px, 
                                                400px" title="bombardier Challenger 350" width="1200" height="800"
                                        loading="lazy" decoding="async"
                ...
                <section class="aircraft-capacity">
                    ...
                    <div class="capacity-layout">
                        ...
                        <div class="seating-diagram">
                            <img src="/img/aeronaves/aviones/Challenger350.webp"
                                alt="Bombardier Challenger 350 super jet mediano para vuelos charter en Perú"
