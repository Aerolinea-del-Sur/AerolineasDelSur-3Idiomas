                            ...
                            <div class="new-carousel-container">
                                <div class="new-carousel-track">
                                    <div class="new-carousel-slide current-slide">
                                        <img src="/img/aeronaves/aviones/Challenger601-1.webp" alt="challenger 601 range"
                                            class="carousel-image" sizes="(max-width: 890px) 550px, 
                                                (max-width: 310px) 310px, 
                                                400px" title="challenger 601 range" width="1200" height="800"
                                    ...
                                    <div class="new-carousel-slide">
                                        <img src="/img/aeronaves/aviones/Challenger601-2.webp" alt="challenger 601 specs"
                                            class="carousel-image" sizes="(max-width: 890px) 550px, 
                                                (max-width: 310px) 310px, 
                                                400px" title="challenger 601 specs" width="1200" height="800"
                                            loading="lazy" decoding="async"
                                            style="width: 100%; height: 100%; object-fit: cover; border-radius: 15px;">
                                        <scripttype="application /ld+json">
                                            {
                                    ...
                                    <div class="new-carousel-slide">
                                        <img src="/img/aeronaves/aviones/Challenger601-3.webp" alt="challenger 601 interior"
                                            class="carousel-image" sizes="(max-width: 890px) 550px, 
                                                (max-width: 310px) 310px, 
                                                400px" title="challenger 601 interior" width="1200" height="800"
                                            loading="lazy" decoding="async"
                                            style="width: 100%; height: 100%; object-fit: cover; border-radius: 15px;">
                                        <scripttype="application /ld+json">
                                            {
                                    ...
                                    <div class="new-carousel-slide">
                                        <img src="/img/aeronaves/aviones/Challenger601-4.webp"
                                            alt="bombardier challenger 601" class="carousel-image" sizes="(max-width: 890px) 550px, 
                                                (max-width: 310px) 310px, 
                                                400px" title="bombardier challenger 601" width="1200" height="800"
                                            loading="lazy" decoding="async"
                                            style="width: 100%; height: 100%; object-fit: cover; border-radius: 15px;">
                                        <scripttype="application /ld+json">
                                            {
                    ...
                    <section class="aircraft-capacity">
                        ...
                        <div class="capacity-layout">
                            ...
                            <div class="seating-diagram">
                                <img src="/img/aeronaves/aviones/Challenger601.webp"
                                    alt="Bombardier Challenger 601 jet ejecutivo para vuelos charter en Perú"
