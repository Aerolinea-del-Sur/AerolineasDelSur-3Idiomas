@php
    ...
    $seo = seo()
        ->title("$aircraft_model - Jet Gran Capacidad | Aerolíneas del Sur")
        ->description("El $aircraft_model es un jet de gran capacidad para 16 pasajeros con alcance transcontinental.")
        ->keywords(['challenger 850 perú', 'bombardier 850', 'jet gran capacidad', 'vuelo corporativo'])
        ->image(asset('img/aeronaves/aviones/Challenger850.webp'))
                        ...
                        <div class="new-carousel-container">
                            <div class="new-carousel-track">
                                <div class="new-carousel-slide current-slide">
                                    <img src="/img/aeronaves/aviones/Challenger850-1.webp" alt="challenger 850 jet"
                                        class="carousel-image" sizes="(max-width: 890px) 550px, 
                                            (max-width: 310px) 310px, 
                                            400px" title="challenger 850 jet" width="1200" height="800" loading="lazy"
                                        decoding="async"
                                    ...
                                    <scripttype="application /ld+json">
                                        ...
                                        "@type": "ImageObject",
                                        "contentUrl":
                                        "https://www.micosina.online/img/aeronaves/aviones/Challenger850-1.webp",
                                        "creator": {
                                        "@type": "Organization",
                                        },
                                ...
                                <div class="new-carousel-slide">
                                    <img src="/img/aeronaves/aviones/Challenger850-2.webp" alt="bombardier challenger 850"
                                        class="carousel-image" sizes="(max-width: 890px) 550px, 
                                            (max-width: 310px) 310px, 
                                            400px" title="bombardier challenger 850" width="1200" height="800"
                                    ...
                                    <scripttype="application /ld+json">
                                        ...
                                        "@type": "ImageObject",
                                        "contentUrl":
                                        "https://www.micosina.online/img/aeronaves/aviones/Challenger850-2.webp",
                                        "creator": {
                                        "@type": "Organization",
                                        },
                                ...
                                <div class="new-carousel-slide">
                                    <img src="/img/aeronaves/aviones/Challenger850-3.webp" alt="challenger 850 vistajet"
                                        class="carousel-image" sizes="(max-width: 890px) 550px, 
                                            (max-width: 310px) 310px, 
                                            400px" title="challenger 850 vistajet" width="1200" height="800" loading="lazy"
                                        decoding="async"
                                        style="width: 100%; height: 100%; object-fit: cover; border-radius: 15px;">
                                    <scripttype="application /ld+json">
                                        {
                                        ...
                                        "@type": "ImageObject",
                                        "contentUrl":
                                        "https://www.micosina.online/img/aeronaves/aviones/Challenger850-3.webp",
                                        "creator": {
                                        "@type": "Organization",
                                        },
                                ...
                                <div class="new-carousel-slide">
                                    <img src="/img/aeronaves/aviones/Challenger850-4.webp"
                                        alt="bombardier challenger 850 private jet" class="carousel-image" sizes="(max-width: 890px) 550px, 
                                            (max-width: 310px) 310px, 
                                            400px" title="bombardier challenger 850 private jet" width="1200" height="800"
                                        loading="lazy" decoding="async"
                                        style="width: 100%; height: 100%; object-fit: cover; border-radius: 15px;">
                                    <scripttype="application /ld+json">
                                        {
                                        ...
                                        "@type": "ImageObject",
                                        "contentUrl":
                                        "https://www.micosina.online/img/aeronaves/aviones/Challenger850-4.webp",
                                        "creator": {
                                        "@type": "Organization",
                                        },
                ...
                <section class="aircraft-capacity">
                    ...
                    <div class="capacity-layout">
                        ...
                        <div class="seating-diagram">
                            <img src="/img/aeronaves/aviones/Challenger850.webp"
                                alt="Bombardier Challenger 850 jet grande para vuelos charter transcontinentales desde Perú"
